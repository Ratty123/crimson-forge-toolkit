...
from crimson_forge_toolkit.models import ArchiveEntry, ModelPreviewData, ModelPreviewMesh, RunCancelled
...
def _parse_best_global_mesh(
    ...
    *,
    ...
    for candidate_index_offset in _find_global_index_offset_candidates(data, geom_offset, raw_mesh, stop_event=stop_event):
