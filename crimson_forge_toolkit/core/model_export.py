...
from crimson_forge_toolkit.models import ModelPreviewData, ModelPreviewMesh
...
def export_model_preview_to_obj(model_preview: ModelPreviewData, output_obj_path: Path) -> Path:
    ...
    obj_lines: List[str] = [
        "# Exported by Crimson Forge Toolkit",
        f"mtllib {mtl_path.name}",
    ]
    mtl_lines: List[str] = ["# Exported by Crimson Forge Toolkit"]
