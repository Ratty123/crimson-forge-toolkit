...
def build_app_stylesheet(
    ...
    *,
    ...
    role_text = {
        "identity": "#0369a1" if theme_key == "light" else "#7dd3fc",
        "dds": "#047857" if theme_key == "light" else "#86efac",
        "ncnn": "#6d28d9" if theme_key == "light" else "#c4b5fd",
        "correction": "#b45309" if theme_key == "light" else "#fbbf24",
    }
    return f"""
    QWidget {{
